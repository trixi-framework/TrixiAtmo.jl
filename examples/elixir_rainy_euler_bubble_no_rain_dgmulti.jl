...
solver = DGMulti(polydeg=polydeg, element_type = Quad(), approximation_type = GaussSBP(), #TODO
                 surface_integral = SurfaceIntegralWeakForm(flux_lax_friedrichs),
                 volume_integral = VolumeIntegralWeakForm()) #TODO
...
semi = SemidiscretizationHyperbolic(mesh, equations,
                                    ...
                                    source_terms = source_terms_moist_bubble,
