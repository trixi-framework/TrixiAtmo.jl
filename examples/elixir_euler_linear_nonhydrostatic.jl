...
struct NonHydrostaticSetup
	...
	function NonHydrostaticSetup(; g = 9.81, c_p = 1004.0, c_v = 717.0, gamma = c_p / c_v, p_0 = 100_000.0, theta_0 = 280.0, u0 = 10.0, z_B = 15000.0, z_T = 30000.0)
		Nf = 0.01
...
function (setup::NonHydrostaticSetup)(u, x, t, equations::CompressibleEulerEquations2D)
	...
	du4 = rho * (theta - theta_b) * (S_v + S_h1 + S_h2) * K * gamma / (gamma - 1.0) * (rho_theta)^(gamma - 1.0) + du2 * v1 + du3 * v2
