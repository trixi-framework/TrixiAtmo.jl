...
struct CovariantShallowWaterEquations2D{RealT <: Real} <: AbstractCovariantEquations2D{6} 
...
@inline function (dissipation::DissipationLocalLaxFriedrichs)(u_ll, u_rr,
    ...
    return -0.5f0 * λ * SVector(u_rr[1] - u_ll[1], 
                                u_rr[2] - u_ll[2], 
                                u_rr[3] - u_ll[3], 
                                z, z, z)
end
...
@inline function flux_nonconservative_naive(u_ll, u_rr, orientation::Integer,
    ...
    if orientation == 1
        ...
        a11_ll = (T_con_11_ll * G_cov_12_ll + 3 * T_con_12_ll * G_cov_22_ll) / (2 * G_ll)
    ...
    return SVector(z, a11_ll * G_cov_11_rr + a12_ll * G_cov_12_rr + a13_ll * G_cov_22_rr,
...
@inline function cartesian2contravariant(u_cartesian, ::CovariantShallowWaterEquations2D,
                                            i, j, element, cache)
