...
function initial_condition_weak_blast_wave(x, t, equations::CompressibleRainyEulerEquationsExplicit2D)
    # constants
    ...
    return SVector(rho_dry, rho_vapour, rho_cloud, rho_rain, rho * v1, rho * v2, energy_density)
end
