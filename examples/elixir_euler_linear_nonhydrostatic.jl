...
struct NonHydrostaticSetup
    ...
    function NonHydrostaticSetup(; g = 9.81, c_p = 1004.0, c_v = 717.0, gamma = c_p / c_v,
                                 p_0 = 100_000.0, theta_0 = 280.0, u0 = 10.0, z_B = 15000.0,
                                 z_T = 30000.0)
        Nf = 0.01
...
semi = SemidiscretizationHyperbolic(mesh, equations, linear_nonhydrostatic_setup, solver,
