...
using Trixi
using TrixiAtmo
using TrixiAtmo: source_terms_no_phase_change, flux_LMARS



# copied from elixir_euler_warm_bubble.jl for quick tests
function initial_condition_bubble_dry(x, t, equations::CompressibleRainyEulerPotentialTemperatureEquations2D)
    g   = equations.gravity
    ...
    return SVector(rho, 0.0, 0.0, rho * v1, rho * v2, rho * potential_temperature, 0.0, 0.0, 0.0)
end
