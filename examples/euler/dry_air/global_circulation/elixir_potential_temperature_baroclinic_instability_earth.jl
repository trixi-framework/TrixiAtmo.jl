...
delta_topo = (60.0 / 3600) * (2 * pi) / 360 # 60 seconds in radians

mesh = TrixiAtmo.P4estMeshCubedSphereHorography(trees_per_cube_face..., EARTH_RADIUS, 30000,
                            polydeg = polydeg, initial_refinement_level = 0, horography = topo, delta_horography = delta_topo, adapt_vertical_grid = TrixiAtmo.GalChen())
