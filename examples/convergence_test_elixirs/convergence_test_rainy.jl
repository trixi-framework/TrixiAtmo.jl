...
function initial_condition_convergence_test_rainy(x, t, equations::CompressibleRainyEulerEquations2D)
    ...
    return SVector(rho_dry, rho_moist, rho_rain, rho, rho, energy, rho_vapour, rho_cloud, temperature)
end
...
function source_terms_convergence_test_rainy(u, x, t, equations::CompressibleRainyEulerEquations2D)
    ...
    return SVector(S_rho_dry, S_rho_moist, S_rho_rain, S_rho_v1, S_rho_v2, S_energy, 0.0, 0.0, 0.0)
end
...
#convergence_test("TrixiAtmo.jl/examples/convergence_test_elixirs/convergence_test_rainy.jl", 3)