...
varnames(::typeof(cons2prim), ::CompressiblePotentialEulerEquations2D) = ("rho", "v1", "v2", "p1")
...
@inline function flux(u, orientation::Integer, equations::CompressiblePotentialEulerEquations2D)
	rho, rho_v1, rho_v2, rho_theta = u
	v1 = rho_v1 / rho
	v2 = rho_v2 / rho
...
@inline function source_terms_bubble(u, x, t, equations::CompressiblePotentialEulerEquations2D)
	rho, _, _, _ = u
