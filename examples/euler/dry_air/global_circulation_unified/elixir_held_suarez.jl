...
using TrixiAtmo: IdealGas,
                 initial_condition_isothermal_generator,
                 source_terms_gravity_spherical_generator,
                 source_terms_coriolis_generator,
                 source_terms_hs_relaxation_generator,
...
source_terms_hs_relaxation_reference = source_terms_hs_relaxation_generator(parameters,
                                                                            equations)

source_terms = transform_source_terms_sum((source_terms_coriolis_reference,
                                           source_terms_hs_relaxation_reference), equations)
