...
mesh_file = joinpath("out", "GingerbreadMan.mesh")
...
boundary_conditions_dirichlet = Dict(:Body => BoundaryConditionDirichlet(initial_condition_schaer_mountain)
                                     :Button1 => BoundaryConditionDirichlet(initial_condition_schaer_mountain)
                                     :Button2 => BoundaryConditionDirichlet(initial_condition_schaer_mountain)
                                     :Eye1 => BoundaryConditionDirichlet(initial_condition_schaer_mountain)
                                     :Eye2 => BoundaryConditionDirichlet(initial_condition_schaer_mountain)
                                     :Smile => BoundaryConditionDirichlet(initial_condition_schaer_mountain)
                                     :Bowtie => BoundaryConditionDirichlet(initial_condition_schaer_mountain))
