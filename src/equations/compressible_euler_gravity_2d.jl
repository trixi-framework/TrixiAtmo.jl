...
@inline Trixi.entropy(cons, equations::CompressibleEulerEquationsWithGravity2D) = entropy_math(cons,
                                                                                               equations)

# Calculate total energy for a conservative state `cons`
@inline Trixi.energy_total(cons, ::CompressibleEulerEquationsWithGravity2D) = cons[4]
