...
function CompressibleMoistEulerEquations2D(; g = 9.81, RealT = Float64)
    ...
    return CompressibleMoistEulerEquations2D{RealT}(p_0, c_pd, c_vd, R_d, c_pv, c_vv,
                                                    R_v, c_pl, convert(RealT, g), kappa, gamma, L_00)
end
...
function initial_condition_convergence_test_dry(x, t,
                                                equations::CompressibleMoistEulerEquations2D)
...
@inline function source_terms_convergence_test_dry(u, x, t,
                                                   equations::CompressibleMoistEulerEquations2D)
...
function initial_condition_convergence_test_moist(x, t,
                                                  equations::CompressibleMoistEulerEquations2D)
    @unpack R_d, R_v, c_vd, c_vv, c_pl, L_00 = equations
...
# Extends the convergence test to the system with gravity and phase change.
@inline function source_terms_convergence_test_moist(u, x, t,
                                                     equations::CompressibleMoistEulerEquations2D)
    # Same settings as in `initial_condition`
    @unpack R_d, R_v, c_vd, c_vv, c_pl, L_00 = equations
    c = 2
...
# Gravity source term
@inline function source_terms_geopotential(u, x, t,
                                           equations::CompressibleMoistEulerEquations2D)
    @unpack g = equations
    rho, rho_v1, rho_v2, rho_e, rho_qv, rho_ql = u
    tmp = rho_v2
...
@inline function source_terms_geopotential(u,
                                           equations::CompressibleMoistEulerEquations2D)
    @unpack g = equations
    rho, rho_v1, rho_v2, rho_e, rho_qv, rho_ql = u
    tmp = rho_v2
...
@inline function source_terms_moist_bubble(u, x, t,
                                           equations::CompressibleMoistEulerEquations2D)
...
@inline function phase_change_term(u, equations::CompressibleMoistEulerEquations2D{RealT}) where {RealT}
...
@inline function source_terms_phase_change(u,
                                           equations::CompressibleMoistEulerEquations2D)
...
@inline function cons2moist(u, equations::CompressibleMoistEulerEquations2D{RealT}) where {RealT}
...
@inline function dry_pottemp_thermodynamic(cons,
                                           equations::CompressibleMoistEulerEquations2D)
...
@inline function moist_pottemp_thermodynamic(cons,
                                             equations::CompressibleMoistEulerEquations2D)
    @unpack R_d, R_v, c_pd, c_pv, c_pl, p_0 = equations
    # Pressure
    p, T = get_current_condition(cons, equations)
...
@inline function cons2aeqpot(cons, equations::CompressibleMoistEulerEquations2D{RealT}) where {RealT}
...
@inline function flux_chandrashekar(u_ll, u_rr, normal_direction::AbstractVector,
    ...
    T_ll = (rho_e_ll - L_00 * rho_qv_ll) /
           (rho_qd_ll * c_vd + rho_qv_ll * c_vv + rho_ql_ll * c_pl)
    T_rr = (rho_e_rr - L_00 * rho_qv_rr) /
           (rho_qd_rr * c_vd + rho_qv_rr * c_vv + rho_ql_rr * c_pl)
    ...
    f4 = ((c_vd * inv_T_mean - K_avg) * f_1d +
          (L_00 + c_vv * inv_T_mean - K_avg) * f_1v +
