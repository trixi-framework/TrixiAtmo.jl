...
solver = DGMulti(polydeg=polydeg, element_type = Quad(), approximation_type = GaussSBP(),
...
mesh = DGMultiMesh(solver, cells_per_dimension; coordinates_min, coordinates_max, periodicity = (true, false))
